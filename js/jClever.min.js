...
e.validate.items[f][g];break;case "numeric":!0!=n.isNumeric(c[f].value)&&(d[f]=e.validate.items[f][g]);break;case "str":!0!=n.isString(c[f].value)&&(d[f]=e.validate.items[f][g]);break;case "stringAndNumeric":!0!=n.isAnyText(c[f].value)&&(d[f]=e.validate.items[f][g]);break;case "mail":!0!=n.isEmail(c[f].value)&&(d[f]=e.validate.items[f][g]);break;case "siteURL":!0!=n.isSiteURL(c[f].value)&&(d[f]=e.validate.items[f][g])}f=0;for(var h in d)if(void 0!=c[h]){g=d[h];var i=a(c[h]).parents(".jClever-element"),
j=i.find("."+e.errorClassTemplate);i.addClass("error");j.text(g);f++}return f?!1:!0});a(b).find("input[type=text], textarea").each(function(){var b=a(this),d=a(this).data("placeholder");""==b.val()&&b.val(d).addClass("placeholdered");b.focusin(function(){b.val()==d&&b.val("").removeClass("placeholdered")});b.focusout(function(){""==b.val()&&b.val(d).addClass("placeholdered")})});e.applyTo.select&&a(b).find("select").each(function(){k[a(this).attr("name")]={type:"select",value:a(this).attr("value")};
...
"]").html(b).trigger("update");return!1},updateFromJsonObject:function(b){var c="",g;for(g in b)c+='<option value="'+g+'">'+b[g]+"</option>";a("select[name="+this.object[0].name+"]").html(c).trigger("update");return!1}};return b},selectActivate:function(b,c,d){l[a(b).attr("name")]={};m=h.selectCollectionExtend(m,a(b));var f=a(b).width();a(b).wrap('<div class="jClever-element" style="z-index:'+c+';"><div class="jClever-element-select-wrapper" style="width:'+f+"px; z-index:"+c+';"><div class="jClever-element-select-wrapper-design"><div class="jClever-element-select-wrapper-design">').after('<span class="jClever-element-select-center"></span><span class="jClever-element-select-right"><span>v</span></span><div class="jClever-element-select-list-wrapper" style="z-index:'+
c+';"><ul class="jClever-element-select-list"></ul></div>');var g=a(b).parents(".jClever-element").attr("tabindex",d),i=g.find(".jClever-element-select-center");g.find(".jClever-element-select-right");var k=g.find(".jClever-element-select-list"),j=g.find(".jClever-element-select-list-wrapper"),c=a("label[for="+a(b).attr("id")+"]");a(b).attr("disabled")&&g.addClass("disabled");g.append(e.errorTemplate);a(b).find("option").each(function(){a(this).is(":selected")?g.find(".jClever-element-select-list").append(a('<li class="active" data-value="'+
a(this).val()+'"><span><i>'+a(this).text()+"</i></span></li>")):g.find(".jClever-element-select-list").append(a('<li data-value="'+a(this).val()+'"><span><i>'+a(this).text()+"</i></span></li>"))});a(b).find(":selected")?i.text(a(b).find("option:selected").text()):i.text(a(b).find("option:eq(0)").text());g.on("click.jClever",".jClever-element-select-center, .jClever-element-select-right",function(){if(a(b).attr("disabled"))return!1;j.is(":visible")?a(".jClever-element-select-list-wrapper").hide():
(a(".jClever-element-select-list-wrapper").hide(),j.show(),l[a(b).attr("name")]=j.jScrollPane().data("jsp"))});j.on("blur.jClever",function(){a(this).hide()});g.on("click.jClever","li",function(){var c=a(this).attr("data-value");k.find("li.active").removeClass("active");a(this).addClass("active");a(b).find("option").removeAttr("selected");a(b).find('option[value="'+c+'"]').attr("selected","selected");a(b).trigger("change");j.hide();return!1});a(b).on("change.jClever",function(){if(a(this).attr("disabled"))return!1;
i.text(a(this).find(":selected").text())});a(b).on("update.jClever",function(){var c=a(this).parents(".jClever-element-select-wrapper").find(".jClever-element-select-list").empty();a(this).find("option").each(function(){c.append(a('<li data-value="'+a(this).val()+'"><span><i>'+a(this).text()+"</i></span></li>"))});a(this).parents(".jClever-element-select-wrapper").find(".jClever-element-select-center").text(a(b).find("option:eq(0)").text())});g.on("focus.jClever",function(){a(this).addClass("focused")}).blur(function(){a(this).removeClass("focused")});
c.on("click.jClever",function(){g.trigger("focus");j.show();l[a(b).attr("name")]=j.jScrollPane().data("jsp")});var n="",p=null;g.on("keydown.jClever",function(c){var d=a(b)[0].selectedIndex;switch(c.keyCode){case 40:if(a(b).attr("disabled"))return!1;d<a(b).find("option").length-1&&d++;break;case 38:if(a(b).attr("disabled"))return!1;0<d&&d--;break;case 13:if(j.is(":visible"))j.hide();else{if(a(b).attr("disabled"))return!1;j.show();l[a(b).attr("name")]=j.jScrollPane().data("jsp")}break;case 32:if(j.is(":visible"))j.hide();
else{if(a(b).attr("disabled"))return!1;j.show();l[a(b).attr("name")]=j.jScrollPane().data("jsp")}break;case 9:return j.hide(),!0;default:n+=String.fromCharCode(c.keyCode),clearTimeout(p),p=setTimeout(function(){for(var c=0,f=a(b)[0].options.length,e=0;e<f;e++)if("string"==typeof a(b)[0].options[e].text){var h=a(b)[0].options[e].text.toUpperCase();if(RegExp("^"+n,"i").test(h)){d=c;a(b)[0].selectedIndex=d;g.find("li.selected").removeClass("selected");g.find("li:eq("+d+")").addClass("selected");g.find("option").removeAttr("selected");
g.find("option:eq("+d+")").attr("selected","selected");a(b).trigger("change");j.is(":visible")&&l[a(b).attr("name")].scrollToElement(g.find("li:eq("+d+")"));break}c++}n=""},500)}a(b)[0].selectedIndex=d;g.find("li.selected").removeClass("selected");g.find("li:eq("+d+")").addClass("selected");g.find("option").removeAttr("selected");g.find("option:eq("+d+")").attr("selected","selected");a(b).trigger("change");j.is(":visible")&&l[a(b).attr("name")].scrollToElement(g.find("li:eq("+d+")"));return!1})},
checkboxActivate:function(b,c){var d=a(b).wrap('<div class="jClever-element" tabindex="'+c+'">').addClass("hidden").after('<span class="jClever-element-checkbox-twins"><span class="jClever-element-checkbox-twins-element"></span><span class="jClever-element-checkbox-twins-color"></span></span>'),f=d.attr("id");d.parents(".jClever-element").append(e.errorTemplate);d.is(":checked")&&(d.next(".jClever-element-checkbox-twins").addClass("checked"),a("label[for="+f+"]").addClass("active"));a(b).attr("disabled")&&
d.parents(".jClever-element").addClass("disabled");d.on("change.jClever",function(){if(a(this).attr("disabled"))return!1;a(this).is(":checked")?(d.next(".jClever-element-checkbox-twins").addClass("checked"),a("label[for="+f+"]").addClass("active")):(d.next(".jClever-element-checkbox-twins").removeClass("checked"),a("label[for="+f+"]").removeClass("active"))});d.next(".jClever-element-checkbox-twins").on("click",function(){var b=a(this);b.prev("input[type=checkbox]").is(":checked")?b.prev("input[type=checkbox]").removeAttr("checked"):
...
c){var d=a(b).wrap('<div class="jClever-element" tabindex="'+c+'">').addClass("hidden").after('<span class="jClever-element-radio-twins"><span class="jClever-element-radio-twins-element"></span><span class="jClever-element-radio-twins-color"></span></span>'),f=d.attr("id");d.parents(".jClever-element").append(e.errorTemplate);d.is(":checked")&&(d.next(".jClever-element-radio-twins").addClass("checked"),a("label[for="+f+"]").addClass("active"));a(b).attr("disabled")?d.parents(".jClever-element").addClass("disabled"):
(d.on("change.jClever",function(){if(a(this).attr("disabled"))return!1;var c=a(this);c.is(":checked")?(c.next(".jClever-element-radio-twins").addClass("checked"),a("label[for="+f+"]").addClass("active")):(c.next(".jClever-element-radio-twins").removeClass("checked"),a("label[for="+f+"]").removeClass("active"));a('input:radio[name="'+a(b).attr("name")+'"]').not(a(b)).each(function(){a(this).attr("checked",!1).next(".jClever-element-radio-twins").removeClass("checked");a("label[for="+a(this).attr("id")+
